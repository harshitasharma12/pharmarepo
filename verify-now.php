  ...
  if(is_post_request()){
    ...
    if(is_array($user)){
      ...
      $expFormat = mktime(date("H"), date("i"), date("s"), date("m") ,date("d")+1, date("Y"));
        ...
        mysqli_query($db,"UPDATE customer set verify_key = '".$key."', expDate = '".$expDate."' WHERE email = '".$username ."'");
        mail_for($username, $email, $key, "Verify Account","verify");
        $_SESSION['message'] = "A link is sent to your registered email address. You can activate your account from that link within 24 hrs.";
...
<head>
    ...
    <title>Verify Account - Customer</title>
                    ...
                    <div class="card-body" style="box-shadow:5px 6px 10px grey">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <span class="fs-3">Verify Account</span><br>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="d-grid gap-2 mt-4">
                                        <button class="btn btn-success" type="submit">Verify Now</button>
                                    </div>
                                </form>
